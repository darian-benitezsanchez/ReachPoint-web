import { listCampaigns, deleteCampaign, applyFilters, getStudentId, getAllStudents } from '../data/campaignsData.js';
import { removeProgress, exportSurveyCSV, exportCallOutcomesCSV } from '../data/campaignProgress.js';
      ...
      function confirmRow() {
        return div('actions',
          ...
          btn('Delete','btn btn-small btn-danger', async () => {
            await deleteCampaign(c.id); await removeProgress(c.id);
            Dashboard(root);
          })
        );
      }
